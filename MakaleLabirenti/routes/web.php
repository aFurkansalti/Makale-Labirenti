...
Route::get('article-list', 'App\Http\Controllers\ArticleController@index')->name('article-list');
Route::post('create-article', 'App\Http\Controllers\ArticleController@create')->name('create-article');
